...
| Evidence Transition Verification | Evidence 생성 시 Manifest Validator·checksum을 한 번 통과한 뒤 Inbox source 삭제, 계약 archive 완료 참조, Curation Queue 등록 같은 전환 산출물만 확인하는 단계. Evidence 내용의 보안 판단은 앞 단계 Receipt 결과를 입력으로 사용한다. |
