...
PYTHONPATH=src python3 -m knowledge_os.cli ingest-evidence --provider manual --file <inbox-file> \
  --why-collected <수집-이유> --intended-use <적용-업무>
PYTHONPATH=src python3 -m knowledge_os.cli search --query <query>
PYTHONPATH=src python3 -m knowledge_os.cli audit-knowledge
PYTHONPATH=src python3 -m knowledge_os.cli list-knowledge-inventory
```
