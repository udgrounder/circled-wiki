...
from knowledge_os.core.ingest import CaptureIdempotencyConflict, ingest_evidence
from knowledge_os.core.repository import apply_bundle_revision, create_bundle, find_document_by_id
from knowledge_os.core.evidence import evidence_original_path
...
from knowledge_os.core.bootstrap import bootstrap_knowledge_root
from knowledge_os.core.observations import (
    ISSUE_AREAS, ISSUE_REPORTERS, ISSUE_SEVERITIES, ISSUE_STATUSES,
    record_system_issue, update_system_issue_status,
)
...
def main() -> int:
    ...
    bundle.add_argument("--title", required=True); bundle.add_argument("--type", required=True)
