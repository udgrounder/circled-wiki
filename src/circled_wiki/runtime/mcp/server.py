...
TOOLS = [
    ...
    {"name": "decide_curation_review", "description": "Apply a reviewer decision. A successful new-Draft approval records required provenance in the Bundle, then removes the consumed Review card.", "inputSchema": {"type": "object", "required": ["review_id", "action", "actor"], "properties": {"review_id": {"type": "string"}, "action": {"type": "string", "enum": ["approve", "no_bundle", "needs_changes", "needs_review"]}, "actor": {"type": "string"}, "note": {"type": "string"}}}},
    {"name": "apply_approved_curation_update", "description": "Apply exactly one approved, checksum- and revision-bound update review to its existing Bundle, then remove the consumed Review card.", "inputSchema": {"type": "object", "required": ["review_id", "actor"], "properties": {"review_id": {"type": "string"}, "actor": {"type": "string"}}}},
