...
TOOLS = [
    ...
    {"name": "list_curation_queue", "description": "List pending per-Evidence work items containing only evidence_id and the Vault-relative Evidence path.", "inputSchema": {"type": "object", "properties": {"include_resolved": {"type": "boolean", "default": False}}}},
