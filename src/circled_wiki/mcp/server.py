...
TOOLS = [
    ...
    {"name": "create_draft_bundle", "description": "Create a policy, decision, spec, or reference Draft from one Evidence item. Guide/manual and runbook Drafts require curation review. This tool cannot activate a Bundle.", "inputSchema": {"type": "object", "required": ["domain", "slug", "title", "bundle_type", "summary", "evidence_id", "body", "actor"], "properties": {"domain": {"type": "string"}, "slug": {"type": "string"}, "title": {"type": "string"}, "bundle_type": {"type": "string"}, "summary": {"type": "string"}, "evidence_id": {"type": "string"}, "body": {"type": "string"}, "actor": {"type": "string"}}}},
