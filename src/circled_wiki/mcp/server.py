...
TOOLS = [
    ...
    {"name": "ingest_evidence", "description": "Create immutable Evidence from an Inbox file. Supply any checksum-bound PII Scan Receipt in this creation call.", "inputSchema": {"type": "object", "required": ["inbox_path", "provider", "why_collected", "intended_use"], "properties": {"inbox_path": {"type": "string"}, "provider": {"type": "string"}, "why_collected": {"type": "string"}, "intended_use": {"type": "array", "minItems": 1, "items": {"type": "string"}}, "title": {"type": "string"}, "source_url": {"type": "string"}, "source_locator": {"type": "string"}, "captured_from": {"type": "string", "enum": ["api", "webhook", "manual", "upload", "sync"]}, "reuse_value": {"type": "string", "enum": ["high", "medium", "low"]}, "retention_class": {"type": "string", "enum": ["workflow_reference", "decision_record", "outcome", "general_reference", "ephemeral"]}, "sensitivity_review": {"type": "string", "enum": ["completed", "required", "not_applicable"]}, "idempotency_key": {"type": "string"}, "content_mode": {"type": "string", "enum": ["external_file", "embedded"]}, "pii_scan_receipt": {"type": "object"}}}},
    ...
    {"name": "reconcile_curation", "description": "Use the installed Curation contract to run configured analysis, durable no_bundle decisions, and Review Queue handoffs. It never approves meaning changes or applies revisions.", "inputSchema": {"type": "object", "properties": {"limit": {"type": "integer", "minimum": 1, "maximum": 1000, "default": 100}}}},
    ...
    {"name": "refresh_curation_queue", "description": "Repair workspace/task/curation-queue items by scanning Evidence, Review cards, and Bundle references.", "inputSchema": {"type": "object", "properties": {}}},
    ...
    if method == "initialize":
        ...
        try:
            ...
            if name == "search_knowledge": content = service.search_knowledge(arguments["query"], arguments.get("filters"))
                ...
                pii_scan_receipt=arguments.get("pii_scan_receipt"),
            )
