"""Project-local Circled Wiki settings with backwards-compatible defaults."""
...
def _validate_settings(payload: Dict[str, Any]) -> CircledWikiSettings:
